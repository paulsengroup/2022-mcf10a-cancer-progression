...
def make_cli():
    ...
    cli.add_argument("--dry-run", action="store_const", default=True, const=True, dest="dry_run")
...
if __name__ == "__main__":
    ...
    sample_names = tuple(["10Anew", "10A", "10_alpha", "T1", "C1", "TGFB", "shHPA_Z", "shZ"])
    p = re.compile(r"^.*/HiC_(\d+)_(" + "|".join(sample_names) + r").*_S\d+_R([12]).*.fastq.gz$")
